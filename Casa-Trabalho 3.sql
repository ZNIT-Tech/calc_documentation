--drop function calcular_trabalho_casa_3
CREATE OR REPLACE FUNCTION calcular_trabalho_casa_3(
...
BEGIN
        IF distancia_mensal_input = 0 OR distancia_mensal_input IS NULL THEN
            mes_nome := 'Yearly';
            consumo_usado := distancia_anual_input * consumo_medio_dia_input;
        ELSE
            consumo_usado := distancia_mensal_input * consumo_medio_dia_input;
        ...
        -- Buscar consumo médio e unidade
        EXECUTE format(
            ...
            tipo_veiculo
        ) INTO consumo_medio, composicao_fossil;  -- reutilizando composicao_fossil para guardar a unidade
        ...
        IF composicao_fossil = 'km / kWh' THEN
            ...
            BEGIN
                ...
                RETURN QUERY
                SELECT
                    consumo_calculado, NULL, NULL, NULL, NULL, NULL,
                    emissao_co2, -- emissao_co2
                    0, 0, 0, emissao_co2; -- somente CO₂, sem CH₄/N₂O
                RETURN;
            END;
        END IF;

        -- Se não for km/kWh, segue normalmente
        consumo_calculado := consumo_usado / consumo_medio;
