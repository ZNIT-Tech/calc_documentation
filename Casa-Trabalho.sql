...
BEGIN
    ...
    IF tipo_veiculo IN ('Trem', 'Metro') THEN
        -- Apenas CO₂ fóssil
        emissao_co2 := (nro_passageiros_input * dist_percorrida_input * dias_trabalhados_input * fator_co2) / 1000000;
        emissao_ch4 := 0;
        emissao_n2o := 0;
    ...
    ELSIF tipo_veiculo IN ('Balsa de passageiros', 'Balsa de veículos', 'Balsa híbrida veículos e passageiros') THEN
        ...
        emissao_co2 := (fator_co2 * nro_passageiros_input * dist_percorrida_input * dias_trabalhados_input) / 1000;
        emissao_ch4 := (fator_ch4 * nro_passageiros_input * dist_percorrida_input * dias_trabalhados_input) / 1000;
        emissao_n2o := (fator_n2o * nro_passageiros_input * dist_percorrida_input * dias_trabalhados_input) / 1000;
    ...
    ELSIF tipo_veiculo IN ('Ônibus municipal', 'Ônibus de viagem') THEN
        ...
        emissao_co2_fossil := (fator_co2 * nro_passageiros_input * dist_percorrida_input * dias_trabalhados_input * (1 - perc_biodiesel)) / 1000;
        emissao_ch4_fossil := (fator_ch4 * nro_passageiros_input * dist_percorrida_input * dias_trabalhados_input * (1 - perc_biodiesel)) / 1000;
        emissao_n2o_fossil := (fator_n2o * nro_passageiros_input * dist_percorrida_input * dias_trabalhados_input * (1 - perc_biodiesel)) / 1000;

        -- Calcular emissões biocombustíveis
        emissao_ch4_bio := (fator_ch4_bio * nro_passageiros_input * dist_percorrida_input * dias_trabalhados_input * perc_biodiesel) / 1000;
        emissao_n2o_bio := (fator_n2o_bio * nro_passageiros_input * dist_percorrida_input * dias_trabalhados_input * perc_biodiesel) / 1000;
